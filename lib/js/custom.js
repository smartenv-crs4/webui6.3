...
function processDataCsv(allText, target, url) {
    ...
    div_text.innerHTML= "<br> ... <br> ... <br><a href='"+url+"' target='blank'>Download the original file.</a>";
...
function readXMLResponse(url, target){
    ...
    xReader(url, function(data) {
        ...
        var div_text = '<textarea rows="12ß" cols="500" style="border:none;">' + text_to_load + '</textarea>';
...
{
    jQuery.cookieBar({
        message: jQuery.i18n.t("This website uses session storage, local storage and cookie to store on your browser your preferences and your account information. "),
        //declineButton: true,
        acceptText: jQuery.i18n.t("I understand!"),
        declineText: jQuery.i18n.t("Disable Cookies"),
